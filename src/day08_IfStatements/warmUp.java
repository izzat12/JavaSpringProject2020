...
public class warmUp {
    ...
    public static void main(String[] args) {
        ...
        boolean n1Equaln2 = n1 == n2 && n1 != n3;        // if n1 equal to n2 but not equal with n3
        boolean n1Equaln3 = n1 == n3 && n1 !=n2;          // only n1 and n3 are equal
        boolean n2Equaln3 = n2 == n3 && n2 !=n1;    //only n2 === n3

        boolean allEqual = n1 == n2 && n1==n3;       //Equal

        boolean noneOfEqual = n1 != n2 && n1 !=n3 && n2 !=n3;      //Not Equal
        ...
        if(allEqual){
            System.out.println(n1+ " is equal to " +n2+ " and " +3);
        }
        if(noneOfEqual){
